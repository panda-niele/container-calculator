...
const CAMERA_POSITIONS: Record<CameraView, CameraPosition> = {
  default: { position: [1500, 1500, 2500], target: [600, 120, 600] },
  top: { position: [600, 2000, 600], target: [600, 0, 600] },
  front: { position: [600, 120, 2500], target: [600, 120, 0] },
  side: { position: [2000, 120, 600], target: [0, 120, 600] },
  corner: { position: [1800, 1800, 1800], target: [600, 120, 600] },
};
